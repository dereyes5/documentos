...
function mostrarResumenCompra() {
    ...
    resumenCompra.innerHTML = '<h2>Resumen de la Compra</h2>';
    var carritoItems = document.getElementsByClassName('carrito-item');
    var totalCompra = 0;

    var resumenFacturaHTML = `
        <div id="factura">
    ...
    resumenCompra.innerHTML += resumenFacturaHTML;
    ...
    for (var i = 0; i < carritoItems.length; i++) {
        ...
        var precioFloat = parseFloat(precio.replace('$', '').replace(',', ''));
        ...
        var resumenItemHTML = `
            ...
            <p>Precio total: $${precioTotal.toLocaleString('es')}</p>
            <hr>
        `;

        resumenCompra.innerHTML += resumenItemHTML;
    }

    var resumenTotalHTML = `
        <div>
            <h3>Total de la Compra: $${totalCompra.toLocaleString('es')}</h3>
        </div>
    `;

    resumenCompra.innerHTML += resumenTotalHTML;
}
